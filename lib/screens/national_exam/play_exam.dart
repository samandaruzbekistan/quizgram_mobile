...
class PlayNational extends StatefulWidget {
  const PlayNational({Key? key, required this.examId}) : super(key: key);
  final int examId;

  @override
  State<PlayNational> createState() => _PlayNationalState();
}

class _PlayNationalState extends State<PlayNational> {
  ...
  Future<void> fetchData() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse(WebApiConstans.playNationalExam));
