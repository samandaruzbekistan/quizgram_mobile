...
class NationalExamDetail extends StatefulWidget {
  const NationalExamDetail(
      {Key? key,
  ...
  @override
  State<NationalExamDetail> createState() => _NationalExamDetailState();
}

class _NationalExamDetailState extends State<NationalExamDetail> {
  ...
  Future<void> fetchData() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse(WebApiConstans.checkBuyNational));
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: widgetText('MILLIY SERTIFIKAT',
                            ...
                            Container(
                                ...
                                child: _isLoading
                                  ...
                                  widgetText(
                                      ...
                                      color:Colors.white),
                                      () {
                                    playNationalExam(context, widget.olympicId);
                                  },
                                  height: 56.0,
                                  width: 200.0,
                                  radius: 20.0,
                                  ...
                                  children: [
                                    widgetButton(
                                        widgetText('Sotib olish',fontWeight: FontWeight.w500,
                                          ...
                                          var res =await apiController.buyNationalExam(widget.olympicId,"no_promocode");
                                          if (res == 1) {
                                            setState(() {
                                              _isLoading = true;
                                            });
