...
class TurkishExamDays extends StatefulWidget {
  const TurkishExamDays({Key? key}) : super(key: key);

  @override
  State<TurkishExamDays> createState() => _TurkishExamDaysState();
}

class _TurkishExamDaysState extends State<TurkishExamDays> {
  ...
  Future<void> fetchData() async {
    ...
    var request = http.Request('POST', Uri.parse(WebApiConstans.getTurkishExamDays));
