...
class PlayTurkish extends StatefulWidget {
  const PlayTurkish({Key? key, required this.examId}) : super(key: key);
  final int examId;

  @override
  State<PlayTurkish> createState() => _PlayTurkishState();
}

class _PlayTurkishState extends State<PlayTurkish> {
  ...
  Future<void> fetchData() async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse(WebApiConstans.playTurkishExam));
