...
class Olympics extends StatefulWidget {
  const Olympics({Key? key}) : super(key: key);

  @override
  State<Olympics> createState() => _OlympicsState();
}

class _OlympicsState extends State<Olympics> {
  ...
  Future<void> fetchData() async {
    ...
    var request = http.Request('POST', Uri.parse(WebApiConstans.getOlympics));
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: widgetText('Olimpiadalar jadvali',
